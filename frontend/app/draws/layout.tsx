...
export const metadata: Metadata = {
  title: "Canada Express Entry Draws — Latest CRS Cut-offs | IRCC Tracker",
  description:
  ...
  keywords:
    "express entry draw, CRS cutoff, Canada PR draw, IRCC draw results, latest express entry, CEC draw, FSW draw",
  openGraph: {
