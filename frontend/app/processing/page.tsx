    ...
    <PageLayout activeNav="processing" lastUpdated={lastUpdated}>
      {loading ? (
        ...
        <>
          {/* Header */}
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-white">⏱ Processing Times</h1>
            <p className="text-sm text-gray-400 mt-1">
              Visa wait times for {allCountries.length}+ countries, refreshed daily from IRCC
            </p>
          </div>
          ...
          <div ref={processingRef}>
            <section className="canada-card p-6 sm:p-8 text-center">
              ...
              <h2 className="text-xl font-bold mb-1">{LOCATION_CONFIG[location].label}</h2>
          ...
          {location === "inside" && (
            <div className="canada-card p-5" style={{ borderColor: "rgba(59,130,246,0.25)" }}>
